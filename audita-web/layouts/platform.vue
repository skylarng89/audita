    ...
    >
      ...
      <div class="flex-1 max-w-xl">
        <div class="relative">
          ...
          <input
            type="search"
            placeholder="Search across tenants..."
      ...
      <div class="flex items-center gap-2 ml-auto">
        ...
        <div class="flex items-center gap-2 pl-1">
          ...
          <div
            class="w-8 h-8 rounded-lg bg-primary flex items-center justify-center text-white text-xs font-bold shadow-sm"
          >
            SA
          </div>
        </div>
    ...
    <div class="flex pt-14 min-h-screen">
      ...
      >
        <div class="flex items-center gap-2 px-3 py-2 mb-4">
          <div
            class="w-8 h-8 rounded-lg bg-primary flex items-center justify-center shadow-sm"
          >
            <svg
        ...
        >
          <NuxtLink
            ...
            class="btn-primary btn-md w-full rounded-xl shadow-md shadow-primary/20 text-sm"
          >
            + Provision New Org
          </NuxtLink>
          <button
            @click="logout"
            class="sidebar-link w-full text-left text-danger hover:bg-danger-light hover:text-danger mt-2"
          >
            <svg
