<template>
  <div>
    ...
    <div
      ...
      class="mb-4 rounded-md bg-success-light border border-success px-4 py-3 text-sm text-green-800"
    >
    ...
    <div class="relative my-6">
      ...
      <div class="relative flex justify-center">
        <span
          class="px-3 bg-white dark:bg-surface-dark text-xs text-muted uppercase tracking-widest"
        >
          Or Authorized SSO
        </span>
      </div>
