...
const ACTION_TYPES = [
  ...
  "UAT_WATCHER_ADDED",
  "UAT_WATCHER_REMOVED",
  "UAT_WATCHER_PROMOTED",
  "UAT_APPROVER_DEMOTED",
  "DEPLOYMENT_ASSIGNEE_SET",
  "DEPLOYMENT_ASSIGNEE_CHANGED",
...
function actionLabel(action: string): string {
  const labels: Record<string, string> = {
    ...
    CR_WATCHER_ADDED: "Watcher Added",
    CR_WATCHER_REMOVED: "Watcher Removed",
    CR_WATCHER_PROMOTED: "Watcher Promoted",
    CR_APPROVER_DEMOTED: "Approver Demoted",
    UAT_WATCHER_ADDED: "UAT Watcher Added",
    UAT_WATCHER_REMOVED: "UAT Watcher Removed",
    UAT_WATCHER_PROMOTED: "UAT Watcher Promoted",
    UAT_APPROVER_DEMOTED: "UAT Approver Demoted",
    DEPLOYMENT_ASSIGNEE_SET: "Deployment Assignee Set",
    DEPLOYMENT_ASSIGNEE_CHANGED: "Deployment Assignee Changed",
