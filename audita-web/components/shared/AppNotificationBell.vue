  ...
  <div class="relative" ref="bellRef">
    ...
    <Transition name="fade">
      ...
      >
        ...
        <div class="max-h-80 overflow-y-auto divide-y divide-border dark:divide-border-dark">
          <div
          ...
          <div v-if="notifStore.items.length === 0" class="px-4 py-8 text-center text-sm text-muted">
